...
var file_iot_proto_rawDesc = []byte{
	...
	0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x49, 0x0a, 0x05, 0x43, 0x6c, 0x69,
	0x63, 0x6b, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x64, 0x65, 0x76, 0x69,
	...
	0x7a, 0x6f, 0x6e, 0x65, 0x32, 0x2b, 0x0a, 0x03, 0x49, 0x4f, 0x54, 0x12, 0x24, 0x0a, 0x0a, 0x43,
	0x6c, 0x69, 0x63, 0x6b, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x0a, 0x2e, 0x69, 0x6f, 0x74, 0x2e,
	0x43, 0x6c, 0x69, 0x63, 0x6b, 0x1a, 0x0a, 0x2e, 0x69, 0x6f, 0x74, 0x2e, 0x45, 0x6d, 0x70, 0x74,
	0x79, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x3b, 0x69, 0x6f, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_iot_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_iot_proto_goTypes = []interface{}{
	(*Empty)(nil), // 0: iot.Empty
	(*Click)(nil), // 1: iot.Click
}
var file_iot_proto_depIdxs = []int32{
	1, // 0: iot.IOT.ClickEvent:input_type -> iot.Click
	0, // 1: iot.IOT.ClickEvent:output_type -> iot.Empty
...
type IOTClient interface {
	ClickEvent(ctx context.Context, in *Click, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *iOTClient) ClickEvent(ctx context.Context, in *Click, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/iot.IOT/ClickEvent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IOTServer interface {
	ClickEvent(context.Context, *Click) (*Empty, error)
}
...
func (*UnimplementedIOTServer) ClickEvent(context.Context, *Click) (*Empty, error) {
...
func _IOT_ClickEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Click)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IOTServer).ClickEvent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/iot.IOT/ClickEvent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IOTServer).ClickEvent(ctx, req.(*Click))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _IOT_ClickEvent_Handler,
		},
	},
